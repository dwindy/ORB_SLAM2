...
void FrameDrawer::DrawTextInfo(cv::Mat &im, int nState, cv::Mat &imText)
{
    ...
    void FrameDrawer::Update(Tracking *pTracker) {
        ...
        ///Added Module
        mvORBattributions = pTracker->mCurrentFrame.mvORBAttributions;
        mvLiDARPoints = pTracker->mCurrentFrame.mvLiDARPoints;
        mvPlanes = pTracker->mCurrentFrame.mvPlanes;
        mSegmentsInfo = pTracker->mCurrentFrame.mSegmentsInfo;
        ///-------------------------
