...
RESULT_PATH="results/Ablation/boundbox/TUM"
...
for dataset in "${DATASETS[@]}"; do
    ...
    for i in {1..10}; do
        ...
        # Run ORB_SLAM2
        ./rgbd_tum_yolo ../../Vocabulary/ORBvoc.txt TUM2.yaml "$DATASET_PATH/$dataset/" "$DATASET_PATH/$dataset/associate.txt" TUM variance boundbox || continue
