...
base_gt = "/home/xin/Downloads/DATASET/TUM"
base_result = "/home/xin/Downloads/ORB_SLAM2/Examples/RGB-D/results/revised-result/TUM"
...
for i in range(1, 11):
    ...
    cmd = [
        "evo_ape", "tum", gt_file, "-vas", traj_file
    ]
...
# 保存为 txt
out_file = Path(f"{dataset_name}_ape_summary.txt")
