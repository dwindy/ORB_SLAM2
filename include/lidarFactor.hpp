...
struct LidarEdgeFactor
{
	...
	template <typename T>
	bool operator()(const T *q, const T *t, T *residual) const //re-define operator (), parameter 1: q - rotation, parameter 2: t - trans, parameter 3: residual
	{
									   ...
									   const Eigen::Vector3d last_point_b_, const double s_)
	{
		return (new ceres::AutoDiffCostFunction<
				LidarEdgeFactor, 3, 4, 3>(//residual dimension, q dimension and t dimension
